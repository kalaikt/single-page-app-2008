...
Calendar.prototype.buildString = function(){
	...
	tmpStr += '<table cellspacing="0" border="0" style="border-color:#C0C0C0;">';
	tmpStr += '<thead><tr><td colspan="7" height="8" ><ul style="border-color:#1060C2;">\n'+
			'<li id="cp_prevMonth"><a href="javascript:g_Calendar.changeMonth(-1)" title="Go to previous month">&nbsp;&lt;</a></li>\n'+
			...
			'<li id="cp_nextMonth"><a href="javascript:g_Calendar.changeMonth(1)" title="Go to next month">&gt;</a></li>\n' +
			'<li id="cp_prevYear"><a href="javascript:g_Calendar.changeYear(-1)" title="Go to previous year">&lt;</a></li>\n' +
	...
	tmpStr += '</ul></li>\n<li id="cp_nextYear"><a href="javascript:g_Calendar.changeYear(1)" title="Go to next year">&gt;</a></li>\n</ul></td></tr>';
	...
	tmpStr += '<tr>';
	for (var i=0;i<7;i++){
		tmpStr += '<th><b>' + this.daysOfWeek[(g_startDay+i)%7] + '</b></th>';
	}

	var dtToday = new Date();

	tmpStr += '</tr></thead><tfoot><tr><td colspan="7">Today is: ' + (/^d/.test(this.dateFormat)?dtToday.getDate() + ' ' + this.months[dtToday.getMonth()] + ' ':this.months[dtToday.getMonth()] + ' ' + dtToday.getDate() + ', ') + dtToday.getFullYear()+'</td></tr></tfoot><tbody>';
