<?php /* Smarty version 2.6.18, created on 2008-08-12 05:44:01
...
<body <?php if ($this->_tpl_vars['content'] != "news.tpl" && $this->_tpl_vars['content'] != "contact.tpl"): ?>onload="initScrollLayer();"<?php endif; ?> >
					...
					<tr>
						...
						<td valign="top">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="<?php if ($_SESSION['content'] == 'main.tpl' || ! $_SESSION['content']): ?>menu_img<?php endif; ?> menu" id="main_td"><a href="javascript:object.getData('main','&amp;flag=1');" class="menu" onclick="object.setClass(document.getElementById('main_td'));">Home</a></td>
									<td width="30px"><img src="images/spacer.gif" alt="Spacer" /></td>
									
									<td class="<?php if ($_SESSION['content'] == 'services.tpl'): ?>menu_img<?php endif; ?> menu" id="services_td"><a href="javascript:object.getData('services','&amp;flag=1');" onclick="object.setClass(document.getElementById('services_td'));" class="menu">Services</a></td>
									<td width="30px"><img src="images/spacer.gif" alt="Spacer" /></td>
									<td class="<?php if ($_SESSION['content'] == 'global.tpl'): ?>menu_img<?php endif; ?> menu" id="global_td"><a href="javascript:object.getData('global','&amp;flag=1');" onclick="object.setClass(document.getElementById('global_td'));" class="menu">Global Sourcing</a></td>
									<td width="30px"><img src="images/spacer.gif" alt="Spacer"/></td>
									<td class="<?php if ($_SESSION['content'] == 'news.tpl'): ?>menu_img<?php endif; ?> menu" id="news_td"><a href="javascript:object.getData('news','&amp;flag=1');" class="menu" onclick="object.setClass(document.getElementById('news_td'));">News</a></td>
									<td width="30px"><img src="images/spacer.gif" alt="Spacer"/></td>
                                    <td class="<?php if ($_SESSION['content'] == 'aboutus.tpl'): ?>menu_img<?php endif; ?> menu" id="about_td"><a href="javascript:object.getData('aboutus','&amp;flag=1');" class="menu" onclick="object.setClass(document.getElementById('about_td'));">About us</a></td>
									<td width="30px"><img src="images/spacer.gif" alt="Spacer"/></td>
									<td class="<?php if ($_SESSION['content'] == 'contact.tpl'): ?>menu_img<?php endif; ?> menu" id="cotact_td"><a href="javascript:object.getData('contact','&amp;flag=1');" class="menu" onclick="object.setClass(document.getElementById('cotact_td'));">Contact us</a></td>
								</tr>
							</table>						</td>
					</tr>
				</table>			</td>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "default/".($this->_tpl_vars['content']), 'smarty_include_vars' => array()));
